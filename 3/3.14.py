...
def test():
    assert(is_luhn_valid('5108050116082780')) == True
    assert(is_luhn_valid('4242424242424242')) == True
    assert(is_luhn_valid('4111111111111111')) == True
    assert(is_luhn_valid('4235190001963642')) == True
    assert(is_luhn_valid('5105105105105100')) == True
    assert(is_luhn_valid('5555555555554444')) == True
    assert(is_luhn_valid('5431111111111111')) == True
    assert(is_luhn_valid('6011601160116611')) == True
    assert(is_luhn_valid('1234'))             == False
    assert(is_luhn_valid('1234123412341234')) == False
    assert(is_luhn_valid('5105105105105100')) == True
    assert(is_luhn_valid('378282246310005'))  == True
    assert(is_luhn_valid('6011601160116611')) == True
    assert(is_luhn_valid('371449635398431'))  == True
    assert(is_luhn_valid('378282246310005'))  == True
